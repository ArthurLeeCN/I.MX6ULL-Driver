#ifndef __IMX6ULL_CORE_H__
#define __IMX6ULL_CORE_H__
...
#define IOMUX_SW_MUX_BASE			(0X020E0044)//正点原子的源码是I.MX6UL的，I.MX6ULL的寄存器地址改了，这里的地址是从JTAG_MOD的复用开始的
...
typedef struct 
{
	...
	volatile unsigned int RESERVED_1[2];//寄存器地址不连续，不要向这两个地址写
